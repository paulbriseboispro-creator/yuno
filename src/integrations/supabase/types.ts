  ...
  public: {
    Tables: {
      ...
      affiliate_reported_sales: {
        ...
        Relationships: [
          {
            foreignKeyName: "affiliate_reported_sales_affiliate_event_id_fkey"
            columns: ["affiliate_event_id"]
            isOneToOne: true
            referencedRelation: "affiliate_events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "affiliate_reported_sales_affiliate_id_fkey"
            columns: ["affiliate_id"]
            isOneToOne: false
            referencedRelation: "affiliates"
            referencedColumns: ["id"]
      ...
      agency_promoter_groups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agency_promoter_groups_leader_promoter_id_fkey"
          ...
          {
            foreignKeyName: "agency_promoter_groups_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
      ...
      collab_table_settlement_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "collab_table_settlement_items_settlement_id_fkey"
          ...
          {
            foreignKeyName: "collab_table_settlement_items_table_reservation_id_fkey"
      ...
      collab_table_settlements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "collab_table_settlements_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
      ...
      commission_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "commission_templates_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      event_collab_amendments: {
        Row: {
          ...
          organizer_user_id: string
          prev_responsibilities: Json | null
          prev_split_rules: Json | null
          proposed_by: string
          reason: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "event_collab_amendments_contract_id_fkey"
            columns: ["contract_id"]
            isOneToOne: false
            referencedRelation: "event_collab_contracts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_collab_amendments_organizer_user_id_fkey"
            columns: ["organizer_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_collab_amendments_proposed_by_fkey"
            columns: ["proposed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_collab_amendments_series_contract_id_fkey"
            columns: ["series_contract_id"]
            isOneToOne: false
            referencedRelation: "event_collab_series_contracts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "event_collab_amendments_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
      ...
      guest_lists: {
        ...
        Relationships: [
          {
            foreignKeyName: "guest_lists_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      promoter_announcements: {
        ...
        Relationships: [
          {
            foreignKeyName: "promoter_announcements_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      promoter_payout_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "promoter_payout_items_conversion_id_fkey"
          ...
          {
            foreignKeyName: "promoter_payout_items_payout_id_fkey"
            columns: ["payout_id"]
            isOneToOne: false
            referencedRelation: "promoter_payouts"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      promoter_teams: {
        ...
        Relationships: [
          {
            foreignKeyName: "promoter_teams_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      clear_agency_commission_template: {
        Args: {
          p_agency_id: string
          p_target_id: string
          p_target_type: string
      ...
      dispute_promoter_payout: {
        Args: { p_payout_id: string; p_reason?: string }
        Returns: Json
      }
      distribute_agency_guestlist: {
        Args: { p_allocations: Json; p_guest_list_id: string }
        Returns: undefined
      }
      ...
      follow_organizer: {
        ...
        SetofOptions: {
          from: "*"
          to: "organizer_profile_followers"
          isOneToOne: false
          isSetofReturn: true
        }
      }
      ...
      get_hype_favorite_stats: {
        Args: { _event_id?: string; _since?: string; _venue_id?: string }
        Returns: {
          recent_count: number
          total_count: number
        }[]
      ...
      grant_agency_guestlist_allocation: {
        Args: {
          p_agency_id: string
          p_drink?: number
          p_event_id: string
          p_female?: number
          p_free_before?: string
          p_male?: number
          p_mode?: string
          p_normal?: number
          p_quota: number
      ...
      propose_collab_amendment: {
        Args: {
          p_contract_id?: string
          p_ip?: string
          p_reason?: string
          p_responsibilities?: Json
          p_series_contract_id?: string
          p_split_rules?: Json
          p_user_agent?: string
        }
        Returns: string
      ...
      set_agency_group_override: {
        Args: {
          p_group_id: string
          p_leader_promoter_id: string
          p_override_type: string
          p_override_value: number
        }
        Returns: Json
      }
      set_agency_guestlist_mode: {
      ...
      split_pillar_enabled: {
        Args: { p_pillar: string; p_rules: Json }
        Returns: boolean
      }
      staff_ban_customer: {
        Args: {
