...
const dict: AdminDict = {
  ...
  'adm.auto.k.night_recap.name': ['Next-day night recap', 'Bilan du lendemain', 'Balance del día siguiente'],
  'adm.auto.k.night_recap.desc': ['Sent to the club or organizer from 11 am the day after a night: entries / expected, revenue, spend per head and the gap with the previous night. Also lands in the Console bell. Never for the demo.', 'Envoyé au club ou à l’organisateur à partir de 11 h le lendemain d’une soirée : entrées / attendus, CA, dépense par tête et l’écart avec la soirée précédente. Arrive aussi dans la cloche de la Console. Jamais pour la démo.', 'Enviado al club o al organizador a partir de las 11 h del día siguiente: accesos / esperados, facturación, gasto por persona y la diferencia con la noche anterior. También llega a la campana de la Consola. Nunca para la demo.'],
