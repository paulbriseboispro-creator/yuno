        ...
        >
          <div className="flex items-center gap-4 text-xs">
            <span className="flex items-center gap-1">
              <TrendingUp className="w-3.5 h-3.5" style={{ color: '#E8192C' }} />
              <span className="tabular-nums" style={{ color: 'rgba(255,255,255,0.96)', fontWeight: 500 }}>{stats.activeTables}/{stats.totalTables}</span>
              <span style={{ color: 'rgba(255,255,255,0.36)' }}>{t('vipHost.tables').toLowerCase()}</span>
            </span>
            <span className="flex items-center gap-1">
              <Users className="w-3.5 h-3.5" style={{ color: 'rgba(255,255,255,0.36)' }} />
            ...
            <span className="flex items-center gap-1">
              <Euro className="w-3.5 h-3.5" style={{ color: '#E8192C' }} />
