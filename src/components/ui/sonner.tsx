...
/* Sonner aligné sur ui/toast.tsx : pill sombre compact flouté, ancré sous la
   ...
   Fond : --toast-bg / --toast-error-bg (src/styles/pro-theme.css), clairs sur
   un dashboard pro en thème clair, identiques au sombre partout ailleurs. */
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:w-full group-[.toaster]:bg-[rgb(var(--toast-bg)/0.95)] group-[.toaster]:backdrop-blur-xl group-[.toaster]:text-white group-[.toaster]:border-white/10 group-[.toaster]:shadow-[0_16px_40px_-16px_rgba(0,0,0,0.85)] group-[.toaster]:py-3 group-[.toaster]:px-4 group-[.toaster]:text-[13px] group-[.toaster]:font-medium group-[.toaster]:rounded-2xl",
          ...
          actionButton:
            "group-[.toast]:bg-[#E8192C] group-[.toast]:text-snow group-[.toast]:text-xs group-[.toast]:rounded-full",
          cancelButton:
          ...
          error: "group-[.toaster]:!border-[#E8192C]/45 group-[.toaster]:!bg-[rgb(var(--toast-error-bg)/0.95)]",
        },
      }}
      {...props}
    />
