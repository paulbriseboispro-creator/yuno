    ...
    subs: [
      {
        ...
        page: '/owner/onboarding',
        descFr: "Yuno a 3 piliers : la billetterie (vente en ligne de billets + QR check-in), les tables VIP (réservation + package bouteilles), et les boissons (commande depuis le téléphone pour éviter la queue au bar). Activez les piliers qui correspondent à votre établissement.",
        descEn: "Yuno has 3 pillars: ticketing (online ticket sales + QR check-in), VIP tables (booking + bottle packages), and drinks (order from phone to skip the bar queue). Enable the pillars that match your venue.",
  ...
  },
  {
    ...
    subs: [
      { fr: 'Créer un événement', en: 'Create an event', es: 'Crear un evento', page: '/owner/events' },
      {
        ...
        page: '/owner/tables',
        descFr: "Configurez votre plan de salle, créez des tables avec capacité et prix minimum de consommation. Associez des packages bouteilles avec diluants. Le client réserve en ligne, choisit sa table et paye — vous recevez un virement direct sur votre Stripe.",
        descEn: "Set up your floorplan, create tables with capacity and minimum spend. Add bottle packages with mixers. Customers book online, pick their table and pay — you receive a direct transfer to your Stripe.",
        descEs: 'Configura tu plano de sala con mesas, capacidad y gasto mínimo. Añade packs de botellas con mezcladores. El cliente reserva y paga online, tú recibes transferencia directa.',
      },
      {
        fr: 'Carte des boissons', en: 'Drinks menu', es: 'Carta de bebidas',
        page: '/owner/menu',
        descFr: "Créez votre carte avec catégories, photos et prix. La nuit de l'événement, vos clients scannent un QR code depuis leur téléphone, commandent et paient. La commande arrive en temps réel sur l'écran du barman — zéro queue, plus de tickets papier.",
        descEn: "Create your menu with categories, photos and prices. On the night, customers scan a QR code on their phone, order and pay. The order arrives in real-time on the bartender's screen — no queue, no paper tickets.",
        descEs: 'Crea tu carta con categorías, fotos y precios. Los clientes escanean un QR, piden y pagan desde el móvil. El pedido llega al barman en tiempo real.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subs: [
      { fr: 'Inviter le staff (bouncer, barman…)', en: 'Invite staff (bouncer, bartender…)', es: 'Invitar staff', page: '/owner/staff' },
      {
        ...
        page: '/owner/staff',
        descFr: "L'hôte VIP accueille les clients en réservation de table, vérifie leur identité et les accompagne. Le vestiaire gère les entrées et les numéros. Chacun reçoit un PIN unique et accède à son interface dédiée depuis n'importe quel téléphone — aucun compte à créer pour eux.",
        descEn: "The VIP host greets table booking customers, verifies their identity and escorts them. The cloakroom manages check-ins and ticket numbers. Each gets a unique PIN and accesses their dedicated interface from any phone — no account to create.",
        descEs: 'El anfitrión VIP recibe a los clientes con reserva de mesa y los acompaña. El guardarropa gestiona entradas. Cada uno tiene un PIN y accede desde cualquier móvil.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subs: [
      { fr: 'Publier votre premier événement', en: 'Publish your first event', es: 'Publicar tu primer evento', page: '/owner/events' },
      {
        ...
        page: '/owner/venue',
        descFr: "Une fois votre page complète, activez la visibilité de votre établissement. Votre club apparaît dans l'espace Explore de l'app Yuno et dans les résultats de recherche. Les clients de votre ville verront vos prochaines soirées.",
        descEn: "Once your page is complete, activate your venue visibility. Your club appears in the Yuno app's Explore section and search results. Customers in your city will see your upcoming events.",
        descEs: 'Activa la visibilidad de tu local. Aparecerás en el Explore de Yuno y en los resultados de búsqueda. Los clientes de tu ciudad verán tus próximos eventos.',
      },
    ],
  },
];
