  ...
  const screen = (
    ...
    >
      ...
      <style>{`
        ...
        .yuno-act-ghost:hover { background: rgba(255,255,255,.06) !important; color: ${ACT.t1} !important; }
      ...
      >
        ...
        <div style={{ position: 'relative', height: 6, borderRadius: 999, background: ACT.faint, overflow: 'hidden' }}>
          <div style={{
            ...
            background: finished ? ACT.pos : `linear-gradient(90deg, ${ACT.red}88, ${ACT.red})`,
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {hasPrimary && (
                <button type="button" onClick={onPrimary} className="yuno-act-btn yuno-act-primary" style={{
                  ...
                  background: ACT.red, color: '#fff', fontFamily: ACT.font,
