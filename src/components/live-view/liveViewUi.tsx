...
export const LV = {
  ...
  cHi: 'rgb(var(--ink)/var(--ink-a92,0.92))',
  cMid: 'rgb(var(--ink)/var(--ink-a40,0.40))',
  ...
  return (
    <div className="w-full overflow-hidden rounded-full" style={{ height, background: LV.faint }}>
      <div
        ...
        style={{
          width: `${w}%`,
          background: accent ? `linear-gradient(90deg,${tint(LV.red, '88')},${LV.red})` : `linear-gradient(90deg,${LV.cMid},${LV.cHi})`,
