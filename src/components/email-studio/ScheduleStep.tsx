...
import {
  AlertTriangle, CalendarClock, ChevronDown, Info, Plus, ShieldCheck, Sparkles, Split, Waves, Zap,
} from 'lucide-react';
import { useLanguage } from '@/contexts/LanguageContext';
import EmailCreditsDialog from '@/components/campaigns/EmailCreditsDialog';
import {
  computeThrottlePlan, recommendPlan, suggestRate, MIN_RATE, MAX_DAYS, MIN_DAYS, SMALL_AUDIENCE,
  type PlanWarning, type StudioCampaign, type ThrottleMode, type ThrottlePlan, type ThrottlePlanResult,
} from '@/lib/email';
import { useStudio } from './store';
import { useAudienceCount, useEmailQuota, type EmailQuota, type StudioScope } from './hooks';
import {
