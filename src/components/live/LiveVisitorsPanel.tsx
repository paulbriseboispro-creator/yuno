...
const STAGE_CONFIG = {
  ...
  cart:     { icon: ShoppingCart, color: 'var(--acc-fcd34d)',            labelKey: 'owner.live.stageCart' },
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ background: 'rgb(var(--ink)/0.06)', border: `1px solid ${BORDER}`, color: T2, fontSize: 11.5, fontWeight: 600 }}
          >
            {total}
          </span>
        </div>
