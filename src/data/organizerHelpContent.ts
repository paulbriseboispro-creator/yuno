...
export const organizerHelpCategories: OwnerHelpCategory[] = [
  ...
  // ─── EVENTS ───
  {
    ...
    articles: [
      ...
      },
      {
        ...
        keywords: ['tables', 'vip', 'bottle service', 'table vip', 'mesas', 'zones', 'packs', 'plan de salle', 'floor plan', 'plano', 'formule', 'formule fixée', 'nombre de tables', 'tables par formule', 'package per table', 'fórmula'],
        sections: [
          ...
          { headingKey: 'ohelp.org.tables.s7h', bodyKey: 'ohelp.org.tables.s7b' },
    ...
    articles: [
      ...
      },
      {
        ...
        sections: [
          ...
          { headingKey: 'ohelp.org.campaigns.s7h', bodyKey: 'ohelp.org.campaigns.s7b' },
  ...
  // ─── ECOSYSTEM ───
  {
    ...
    articles: [
      ...
      {
        id: 'org-collaborations',
        titleKey: 'ohelp.org.collab.title',
        descKey: 'ohelp.org.collab.desc',
        icon: 'Handshake',
        quickStart: true,
