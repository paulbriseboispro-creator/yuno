    ...
    articles: [
      {
        ...
        keywords: ['dashboard', 'tableau de bord', 'accueil', 'home', 'kpi', 'revenue', 'revenu', 'ventes', 'sales', 'overview', 'prochaines soirées', 'upcoming nights', 'próximas noches', 'aujourd\'hui', 'today', 'hoy', 'j-2', 'compte à rebours', 'countdown', 'remplissage', 'fill rate', 'jauge', 'dernières soirées', 'last nights', 'últimas noches', 'dépense par tête', 'spend per head', 'gasto por persona', 'entrées', 'entries', 'clients', 'customers', 'à faire aujourd\'hui', 'do this today', 'actions rapides', 'quick actions', 'bannière', 'banner', 'couverture', 'cover', 'photo', 'panel'],
        sections: [
      ...
      },
      {
        ...
        keywords: ['analytics', 'analyse', 'statistiques', 'stats', 'revenue', 'rapport', 'report', 'export', 'kpi', 'period', 'période', 'guest list', 'guestlist', 'no-show', 'invités', 'présence', 'live view', 'en direct', 'temps réel', 'real time', 'globe', 'release', 'visiteurs en ce moment', 'comportement d\'achat', 'purchase behavior', 'comportamiento de compra', 'délai d\'achat', 'lead time', 'panier', 'basket', 'réachat', 'repeat', 'habitués', 'rapport de soirée', 'night report', 'informe', 'comparer', 'compare', 'comparar', 'courbe', 'curve', 'j-n', 'nouveaux contacts', 'new contacts', 'emails de la soirée', 'push de la soirée', 'détail des ventes', 'paliers', 'ventes', 'sales', 'ventas', 'trafic', 'traffic', 'tráfico', 'communauté', 'community', 'comunidad', 'ma page', 'my page', 'visites de la page', 'page views', 'conversion', 'contacts', 'participation', 'dernier achat', 'last purchase', 'partenaires', 'partners', 'public', 'abonnés', 'followers', 'goûts', 'genres', 'hype score', 'dépense par tête', 'spend per head', 'gasto por persona', 'entrées', 'entries', 'dernières soirées', 'last nights', 'projection', 'repère', 'marker', 'soirée par soirée', 'night by night', 'csv', 'objectif', 'target', 'objetivo', 'rythme', 'pace', 'à retenir', 'takeaways', 'lo esencial', 'repères', 'markers', 'bilan du lendemain', 'recap'],
        sections: [
          ...
          { headingKey: 'ohelp.pg.analytics.s16h', bodyKey: 'ohelp.pg.analytics.s16b' },
