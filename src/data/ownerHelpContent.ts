    ...
    articles: [
      {
        ...
        keywords: ['dashboard', 'bannière', 'banner', 'couverture', 'cover', 'photo', 'tableau de bord', 'accueil', 'home', 'kpi', 'revenue', 'revenu', 'ventes', 'sales', 'overview', 'panel', 'prochaines soirées', 'upcoming nights', 'próximas noches', 'aujourd\'hui', 'today', 'hoy', 'j-2', 'compte à rebours', 'countdown', 'remplissage', 'fill rate', 'jauge', 'notifications', 'cloche', 'bell', 'campana'],
        sections: [
          ...
          { headingKey: 'ohelp.pg.dashboard.s9h', bodyKey: 'ohelp.pg.dashboard.s9b' },
        ],
      },
      {
