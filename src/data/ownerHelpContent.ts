  ...
  // ─── MARKETING & CRM (menu group) ───
  {
    ...
    articles: [
      ...
      },
      {
        ...
        keywords: ['email', 'campagne', 'campaign', 'newsletter', 'marketing', 'gdpr', 'rgpd', 'open rate', 'taux ouverture', 'audience', 'segment', 'correo', 'envoi', 'importer', 'import', 'liste', 'list', 'csv', 'base email', 'spam', 'delivrabilite', 'deliverability', 'masse', 'bulk', 'importar', 'lista', 'modele', 'modèle', 'template', 'plantilla', 'reutiliser', 'reutilizar', 'invitation', 'gabarit', 'supprimer', 'brouillon', 'delete', 'draft', 'eliminar', 'borrador', 'corbeille', 'table vip', 'bottle service', 'carre', 'carré', 'formule', 'mesa vip', 'vip table', 'alignement', 'align', 'bloc evenement', 'bloc événement', 'carte soiree', 'carte soirée', 'event block', 'bloque evento', 'mise en page', 'layout', 'cote a cote', 'côte à côte', 'side by side', 'affiche', 'poster', 'cartel', 'segmentation', 'segments intelligents', 'smart segments', 'segmentos', 'base clients', 'customer base', 'ma base', 'base de contacts', 'contact base', 'engagement', 'engagés', 'silencieux', 'cliqueurs', 'ouvertures', 'exporter', 'export', 'effet sur votre base', 'sms', 'telephone', 'téléphone', 'ville', 'city', 'depense', 'dépensé', 'fidele', 'fidèle', 'habitue', 'habitué', 'dormant', 'endormi', 'automatisation', 'automatisations', 'automation', 'automations', 'automatizacion', 'recette', 'panier abandonne', 'panier abandonné', 'abandoned checkout', 'dernier appel', 'last call', 'merci d\'etre venu', 'on t\'a manque', 'bienvenue', 'welcome', 'reconquete', 'reconquête', 'win-back', 'non-ouvreurs', 'renvoyer', 'resend', 'meilleure heure', 'best hour', 'heure d\'envoi'],
        sections: [
          ...
          { headingKey: 'ohelp.pg.campaigns.s18h', bodyKey: 'ohelp.pg.campaigns.s18b' },
          ...
          { headingKey: 'ohelp.pg.campaigns.s26h', bodyKey: 'ohelp.pg.campaigns.s26b' },
          { headingKey: 'ohelp.pg.campaigns.s19h', bodyKey: 'ohelp.pg.campaigns.s19b' },
          { headingKey: 'ohelp.pg.campaigns.s20h', bodyKey: 'ohelp.pg.campaigns.s20b', type: 'tip' },
          { headingKey: 'ohelp.pg.campaigns.s21h', bodyKey: 'ohelp.pg.campaigns.s21b', type: 'tip' },
          { headingKey: 'ohelp.pg.campaigns.s22h', bodyKey: 'ohelp.pg.campaigns.s22b', type: 'warning' },
          { headingKey: 'ohelp.pg.campaigns.s23h', bodyKey: 'ohelp.pg.campaigns.s23b' },
          { headingKey: 'ohelp.pg.campaigns.s24h', bodyKey: 'ohelp.pg.campaigns.s24b' },
          { headingKey: 'ohelp.pg.campaigns.s10h', bodyKey: 'ohelp.pg.campaigns.s10b' },
          { headingKey: 'ohelp.pg.campaigns.s25h', bodyKey: 'ohelp.pg.campaigns.s25b' },
          ...
          { headingKey: 'ohelp.pg.campaigns.s14h', bodyKey: 'ohelp.pg.campaigns.s14b' },
        ],
      },
      {
      ...
      },
      {
        ...
        sections: [
          ...
          { headingKey: 'ohelp.pg.promoters.s8h', bodyKey: 'ohelp.pg.promoters.s8b' },
          { headingKey: 'ohelp.pg.promoters.s9h', bodyKey: 'ohelp.pg.promoters.s9b' },
        ],
      },
      {
        ...
        sections: [
          ...
          { headingKey: 'ohelp.commissionTemplates.s8h', bodyKey: 'ohelp.commissionTemplates.s8b' },
        ],
      },
      {
        id: 'promoter-teams',
      ...
      },
      {
        ...
        sections: [
          ...
          { headingKey: 'ohelp.promoterFinance.s6h', bodyKey: 'ohelp.promoterFinance.s6b', type: 'steps' },
          { headingKey: 'ohelp.promoterFinance.s7h', bodyKey: 'ohelp.promoterFinance.s7b' },
          { headingKey: 'ohelp.promoterFinance.s8h', bodyKey: 'ohelp.promoterFinance.s8b', type: 'warning' },
