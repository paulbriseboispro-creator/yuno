  ...
  // ─── EVENTS (menu group) — fully rewritten page-by-page (mirror témoin) ───
  {
    ...
    articles: [
      ...
      },
      {
        ...
        keywords: ['collaboration', 'organizer', 'organisateur', 'co-event', 'partenaire', 'partner', 'split', 'partage', 'invite', 'inviter', 'propose', 'colaboración'],
        sections: [
          ...
          { headingKey: 'ohelp.ev.collab.s6h', bodyKey: 'ohelp.ev.collab.s6b', type: 'tip' },
        ],
      },
      {
        id: 'scarcity-fomo',
