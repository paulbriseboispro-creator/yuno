...
/* ─── Animated Orb (Siri-style with Yuno red) ─── */
function AnimatedOrb({ intensity = 'idle' }: { intensity: 'idle' | 'searching' }) {
  const isActive = intensity === 'searching';
  return (
    <div className="relative flex items-center justify-center" style={{ width: 220, height: 220 }}>
      ...
      <motion.div
        ...
        style={{
          ...
          background: `conic-gradient(
            ...
            transparent 55%,
            hsl(var(--primary) / 0.45) 75%,
            transparent 90%
          )`,
          filter: 'blur(10px)',
        }}
        animate={{ rotate: 360 }}
        transition={{ duration: isActive ? 2 : 7, repeat: Infinity, ease: 'linear' }}
      />
      ...
      <motion.div
        ...
        animate={{ rotate: -360 }}
        transition={{ duration: isActive ? 1.8 : 5, repeat: Infinity, ease: 'linear' }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          background: `conic-gradient(
            from 240deg,
            transparent 0%,
            hsl(var(--primary) / 0.7) 12%,
            transparent 30%,
            hsl(var(--primary) / 0.4) 50%,
            transparent 68%,
            hsl(var(--primary) / 0.55) 85%,
            transparent 100%
          )`,
          filter: 'blur(4px)',
        }}
      ...
      <motion.div
        ...
        style={{
          width: 70,
          height: 70,
          background: 'radial-gradient(circle, hsl(var(--primary) / 0.8) 0%, hsl(var(--primary) / 0.2) 55%, transparent 100%)',
          filter: 'blur(5px)',
        }}
        animate={{
          scale: isActive ? [1, 1.3, 0.95, 1.2, 1] : [1, 1.08, 1],
        }}
      ...
      <motion.div
        ...
        style={{
          width: 32,
          height: 32,
          background: 'radial-gradient(circle, hsl(0 0% 100% / 0.95) 0%, hsl(var(--primary)) 35%, hsl(var(--primary) / 0.5) 100%)',
          boxShadow: '0 0 30px 12px hsl(var(--primary) / 0.5), 0 0 60px 25px hsl(var(--primary) / 0.2)',
        }}
        animate={{
          scale: isActive ? [1, 1.25, 0.9, 1.2, 1] : [1, 1.06, 1],
        }}
        transition={{ duration: isActive ? 1.8 : 4, repeat: Infinity, ease: 'easeInOut' }}
      />
    </div>
