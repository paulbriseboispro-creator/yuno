...
export default function EventDetails() {
  ...
  // le club ou l'organisateur, pas par l'agence RP. Un RP peut toujours la
  // promouvoir (liens trackés dans l'app) mais n'a aucune présence affichée ici.
  // La carte « RP » ne vit que sur AffiliateEventPage (soirées externes des agences).
  ...
  return (
    <div className="min-h-screen pb-28" style={{ background: '#0A0A0A' }}>
      ...
      <div style={{ maxWidth: '768px', margin: '0 auto' }}>
        ...
        {/* Pas de section « RP » ici : une soirée Yuno est gérée en direct par le
            club / l'organisateur. Les agences RP la promeuvent via des liens trackés
            mais n'ont pas de présence affichée sur la page. */}
