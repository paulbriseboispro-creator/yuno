...
export default defineConfig({
  server: {
    ...
    headers: {
      ...
      "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline' https://js.stripe.com https://connect.facebook.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; worker-src 'self' blob:; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://*.mapbox.com https://resend.com https://www.facebook.com https://connect.facebook.net; img-src 'self' data: blob: https://*.supabase.co https://*.stripe.com https://*.mapbox.com https://cdn.simpleicons.org https://www.facebook.com; media-src 'self' blob: https://*.supabase.co; font-src 'self' data: https://fonts.gstatic.com; frame-src https://js.stripe.com https://hooks.stripe.com; object-src 'none'; base-uri 'self'; form-action 'self'",
    },
  },
  plugins: [
    react(),
