-- Trafic › Ma page : la série jour par jour en une seule passe (2026-09-25).
--
-- Chaque jour de la période relançait un count(*) sur toutes les visites de
-- la page (90 × N conversions de fuseau) : négligeable aujourd'hui (≈ 70 ms à
-- chaud sur la démo), quadratique demain. Les visites sont désormais
-- regroupées par jour une fois, puis collées aux jours. Corps repris de la
-- base liée ; seul le bloc `series` change, le résultat est identique.
