-- =============================================================================
-- Rapport de soirée : la porte (entrées scannées / attendus)
-- =============================================================================
-- Plan de simplification (lot 4) : la phrase-réponse d'une soirée passée dit
-- combien de personnes sont VENUES. `get_event_report` ne le savait pas ; le
-- verdict le recalculait à sa façon, le Hype Score à une autre. `totals.door`
-- suit la définition du dictionnaire (`src/lib/metrics.ts`, « Entrées »), la
-- même que `get_sales_overview`. Réécrit depuis la définition VIVANTE.
-- =============================================================================
