...
const HELP_ARTICLES: Record<string, { title: string; keywords: string[]; path: string; snippet: string }> = {
  ...
  "email-campaigns": {
    ...
    keywords: ["email", "campagne", "campaign", "newsletter", "mailing", "éditeur", "envoi", "ouvertures", "désabonnement", "revenu campagne", "combien a rapporté", "segment personnalisé", "envoi de masse", "masse", "bulk", "spam", "délivrabilité", "delivrabilite", "warm-up", "plafond", "quota", "bounce", "rebond", "plainte", "pause automatique", "envoi bloqué", "envoi en cours", "5000 emails"],
