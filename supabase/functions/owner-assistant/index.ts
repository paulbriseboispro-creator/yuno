...
const HELP_ARTICLES: Record<string, { title: string; keywords: string[]; path: string; snippet: string }> = {
  "appearance": {
    ...
    snippet: "Barre latérale → bloc « Apparence » tout en bas : « Clair » (soleil) ou « Sombre » (lune, le défaut) ; la nouvelle couleur s'ouvre en cercle depuis le bouton. Raccourci : l'icône lune/soleil en haut de chaque page, à côté de la cloche, bascule entre clair et sombre. Le choix est gardé sur l'appareil et vaut pour tous les espaces pro (Console Club, Organisateur, Agence, espaces promoteur et DJ). Les pages publiques, les emails et l'app client ne changent pas ; la bannière photo du tableau de bord, le globe de la vue En direct et les aperçus client restent sombres exprès, comme les écrans du staff de nuit (bar, porte, vestiaire, hôte VIP).",
  },
  "ads": {
    ...
    path: "/owner/ads",
    snippet: "Marketing & CRM → Publicité (ou bouton « Booster » sur la fiche d'une soirée). Il faut d'abord la connexion Meta (Paramètres → Intégrations). L'assistant en cinq étapes nommées, avec retour en arrière : 1) soirée + objectif (Ventes = optimise sur tes vraies ventes, Visites = clics) ; 2) budget (total ou par jour, min 5 €, dates par défaut jusqu'au début de la soirée, facturé par Meta sur ton compte pub, jamais par Yuno) ; 3) ciblage : pays, villes + rayon, âge, genre, tes audiences Yuno à cibler ou exclure, puis le mode de diffusion — « Mes critères, élargis par Meta » (conseillé : zone et tranche d'âge respectées, audiences / jumeaux / intérêts / genre relâchés, Meta diffuse AUSSI à des profils proches), « Laisser Meta décider » (Advantage+ complet : zone + âge minimum 25 max, PAS d'âge maximum, règle Meta) ou « Uniquement ce que je choisis » (rien d'élargi) ; affinage facultatif par centres d'intérêt, langues, Instagram / Facebook, et estimation Meta des personnes atteignables ; 4) créations : une création = une pub, image (affiche par défaut), carrousel 2-10 images ou vidéo MP4/MOV H.264 avec couverture, titre 40, description, texte 500, bouton ; jusqu'à six créations dans la même campagne, elles partagent le budget et Meta le déplace vers celle qui vend le mieux ; 5) relire → « Créer en pause » (Meta valide sous 24 h), activation séparée et confirmée depuis la liste. Chaque pub porte un lien Yuno : la page compte les billets, tables et boissons vendus PAR la pub et le coût par vente, plus les impressions/clics Meta toutes les heures, et « Résultats par création » dit quelle pub a vendu. Audiences : cinq prêtes (contacts consentants, acheteurs 12 mois, tables VIP, guest list, habitués 3+) ou tes segments ; seuls les contacts opt-in email/SMS partent, hachés ; à 100 personnes, bouton « Jumeaux ». Leads : « Activer la réception » et les formulaires Instagram/Facebook tombent dans la base de contacts comme abonnés (jamais un désabonné). Refus Meta fréquents : trop de texte sur l'image, alcool mis en avant ; le motif s'affiche sur la campagne. Mode expert (interrupteur en haut de l'assistant) = tout Ads Manager : objectif Notoriété, événement de conversion (achat / paiement commencé / page vue), enchère (coût plafond, enchère max, retour minimum réservé aux entreprises vérifiées), plages horaires (budget total), UTM, présence dans la zone (habitent / récemment / de passage), villes exclues, codes postaux, point précis (adresse + rayon, jamais dans une ville déjà choisie), ciblage détaillé par groupes (intérêts, comportements, démographie ; « ET aussi » = affiner ; plus d'exclusion d'intérêts chez Meta), placements manuels (Explore n'existe plus) et appareils, création « Publication Instagram » (booster un post existant). Modifier une campagne vivante (budget, dates, ciblage, diffusion ; soirée, objectif et créations figés), dupliquer, mettre en pause une pub seule, ventilations âge / genre / placement. Audiences à règle remplies par Meta : visiteurs de mes pages Yuno (CGU audiences requises), paiement commencé sans achat, engagés Instagram, visiteurs du profil, engagés de la Page ; jumeaux de 1 à 10 %. Trois modes d'audience : « Mes critères, élargis par Meta » (zone + âge stricts, le reste relâché), « Laisser Meta décider » (Advantage+ : âge min 25 max, pas d'âge max), « Uniquement ce que je choisis ». Créations v3 : aperçu Feed / Story / Reel + « Voir le rendu Meta » (aperçu réel), version verticale 9:16 pour stories et reels (sinon Meta recadre), compositeur de story / post depuis l'affiche (gabarits Affiche plein cadre / Encadrée / Bandeau, couleur d'accent, faits de la soirée), puces « Insérer un fait de la soirée » (date, lieu, prix d'appel, line-up), interrupteur « Laisser Meta améliorer la création » (Advantage+ créa). Une création ne choisit pas seule son placement : c'est l'ensemble (étape Ciblage) ; la ligne « Cette campagne diffuse sur » le rappelle. Si une recherche de ville ou d'intérêt affiche « Meta refuse la recherche : API access blocked », c'est un blocage côté Meta (app ou Business Manager), pas un réglage Yuno : attendre ou contacter le support Meta. Destination par création : « Partout », « Feed », « Story » ou « Reel » — dès qu'une création vise un placement précis, un ensemble de pubs par destination et budget au niveau de la campagne réparti par Meta (une campagne = un carrousel feed + un reel + une story, chacun avec ses résultats). Carrousel et publication existante = feed seulement ; story / reel = visuel vertical 9:16 (compositeur). Réservé au propriétaire.",
  },
  "meta-ads": {
    title: "Meta (Facebook & Instagram) : pixel + Conversions API",
    keywords: ["meta", "facebook", "instagram", "pixel", "pub", "publicité", "publicite", "ads", "ads manager", "events manager", "conversions api", "capi", "roas", "retour sur investissement", "jeton", "token", "intégration", "integration", "intégrations", "connexion instagram", "pas de compte facebook", "mot de passe facebook", "business suite", "tracking pub", "suivre mes pubs", "mes pubs marchent", "campagne instagram", "campagne facebook"],
    path: "/owner/integrations",
    snippet: "Paramètres → Intégrations → carte Meta. Le plus simple est « Connecter avec Facebook » : une fenêtre Meta, tu choisis ton entreprise, Yuno trouve ton pixel, ton compte pub et ta Page. Si ton compte professionnel Meta a été ouvert DEPUIS Instagram, ce bouton ne peut pas marcher : Meta exige un profil Facebook pour autoriser une application, et sa fenêtre de connexion ne propose pas Instagram (ouvrir une session Business Suite avec Instagram n'y change rien). Deux solutions, affichées sous le bouton : ajouter un compte Facebook PERSONNEL comme administrateur de ton entreprise depuis business.facebook.com → Paramètres → Personnes, où la connexion Instagram fonctionne (attention : un compte Facebook est une PERSONNE avec son email et son mot de passe ; une Page Facebook n'en est pas un, elle n'a pas d'identifiants et ne peut rien autoriser — créer une Page depuis Business Suite ne débloque pas le bouton) — ensuite tout s'ouvre, publicités comprises ; ou rester sans Facebook et passer par le mode avancé — et là le JETON décide : un jeton d'événements suffit au suivi des ventes, un jeton d'utilisateur système (Business Manager → Paramètres → Utilisateurs → Utilisateurs système, avec le compte publicitaire, le pixel et la Page attribués, généré pour l'app Yuno, permissions ads_management + ads_read + business_management + pages_read_engagement + instagram_basic) ouvre AUSSI les publicités pilotées depuis Yuno, sans jamais passer par Facebook, et il n'expire pas. Sinon, mode avancé : colle l'identifiant de ton pixel (Events Manager → ton jeu de données → Paramètres) et un jeton Conversions API (même page, section API Conversions → Générer un jeton d'accès), éventuellement un code d'événement de test (onglet Événements de test), puis Connecter Meta. À partir de là, chaque vente confirmée (billet, table VIP, boisson) et chaque inscription guest list part vers ton pixel depuis le serveur de Yuno, avec le montant : Meta optimise tes pubs sur de vrais acheteurs et Ads Manager affiche ton retour sur investissement. Les événements ne comptent que les visiteurs qui ont accepté la case « Publicité (Meta) » du bandeau cookies sur yunoapp.eu ; Yuno garde la preuve du consentement pour chaque commande, et rien ne part depuis l'app mobile. La carte montre les envois et échecs sur 7 jours, la valeur transmise sur 30 jours, le taux de consentement, les derniers événements, et des interrupteurs par type d'événement. « Domaine non vérifié » dans Events Manager est normal (les ventes se font sur yunoapp.eu) ; « Jeton refusé » = régénérer le jeton et le recoller. Réservé au propriétaire du compte.",
  },
  "audience-tracking": {
  ...
  "sold-out-manual": {
    title: "Marquer complet (billets, tables VIP, guest list)",
  ...
  "event-report": {
    title: "Le rapport d'une soirée (Analytics › Événement)",
  ...
  "vip-tables": {
    title: "Tables VIP",
    keywords: ["table", "VIP", "réservation", "zone", "minimum", "consommation", "acompte", "deposit", "heure d'arrivée", "arrivée limite", "arrival cutoff", "retard", "arriver tard", "late", "formule", "pack", "formule fixée", "nombre de tables", "tables par formule", "tables max", "une formule par table", "package per table", "limit tables"],
    path: "/owner/tables",
    snippet: "Les Tables VIP permettent de créer des zones avec tables, capacité et minimum de consommation. Les clients réservent avec un acompte. Le VIP host gère les arrivées et les consommations sur place. Par défaut le client choisit sa formule (pack) parmi celles de la zone. Si l'établissement vend chaque table avec SA formule (ex. quatre tables à 6 pers. pour 600 € et deux tables à 8 pour 1 200 € dans la même zone), deux réglages optionnels : sur la formule, « Nombre de tables limité » plafonne ses ventes (Complet quand ses tables sont parties, même si la zone a encore de la place) ; dans l'éditeur de plan, « Formule fixée à cette table » lie une table à une formule (capacité recopiée, le client ne peut réserver cette table qu'avec elle, les tables d'une autre formule sont estompées et cliquer dessus bascule le checkout). Le plafond est la loi : le plan ne peut pas fixer plus de tables à une formule que son plafond (formule « complète » dans l'éditeur, enregistrement refusé par la base), et le plafond ne peut pas descendre sous les tables déjà fixées. Une formule sans plafond en reçoit un automatiquement, égal aux tables fixées, à l'enregistrement du plan. Sur chaque pack tu peux activer une Heure d'arrivée limite optionnelle (ex. 01:00) : quand elle est active, elle s'affiche au client au moment de la réservation (« Arrivée avant … ») pour éviter que des clients arrivent très tard et gardent une table toute la nuit. Pas d'annulation automatique : l'heure est aussi rappelée au videur au scan d'entrée et à l'hôte VIP sur la fiche de la table.",
  },
  "subscription-plans": {
  ...
  "solo-bottles": {
    ...
    snippet: "Option du Mode Live : le club peut vendre des bouteilles entières SANS réservation de table. Le client achète depuis le menu de soirée et retire au bar avec un QR, comme une commande de boissons (le barman scanne pareil). Activation : Événements → Tables VIP → Service VIP → Carte → « Vente de bouteilles sans table ». Exclusion possible bouteille par bouteille (switch « Vente solo »). Les bouteilles à diluant gardent l'étape mixers.",
  },
  "events-create": {
    title: "Créer et publier une soirée",
    keywords: ["événement", "event", "soirée", "créer", "create", "publier", "publish", "poster", "affiche", "vidéo", "video", "reel", "story", "16:9", "9:16", "paysage", "landscape", "hevc", "h264", "codec", "line-up", "lineup", "affiche", "artiste invité", "artiste sans compte", "dj pas inscrit", "dj sans compte yuno", "privé", "mot de passe", "visibilité", "secret", "fuseau", "fuseau horaire", "timezone", "heure", "décalage"],
    path: "/owner/events",
    snippet: "Depuis Événements, crée une soirée : titre, dates, fuseau horaire, affiche, genre musical, line-up DJ. En option, sous l'affiche, « Vidéo de la soirée (16:9) » : une courte vidéo PAYSAGE (MP4 H.264 ou MOV, 1920 × 1080, 60 s et 30 Mo max, vérifiée avant envoi ; un portrait est refusé) qui ouvre la page de la soirée en bandeau large AU-DESSUS du titre, en boucle, sans son, sans bouton — rien ne passe par-dessus le plan, ni le titre ni un bouton ; partout ailleurs (Explore, cartes, emails, passes Wallet) l'affiche reste le seul visuel, et les clients en mode économie de données ou animations réduites voient l'affiche — garde-la nette. Remplacer / Retirer au même endroit, envoi à l'enregistrement seulement. Yuno REFUSE une vidéo HEVC (réglage iPhone « Haute efficacité ») ou tout codec autre que H.264 (illisible sur Android) : réexporter en H.264 ou passer l'iPhone en Réglages → Appareil photo → Formats → « Le plus compatible ». Une soirée récurrente porte aussi sa vidéo par défaut (réglée sur le modèle, recopiée sur chaque date, propagée aux dates à venir non personnalisées). Le champ Fuseau horaire fixe le fuseau dans lequel les heures de début/fin que tu saisis sont interprétées ET affichées (clients, notifications, billets) ; il est pré-rempli avec le fuseau de la ville de ton club et tu peux le changer par soirée. Ainsi une soirée saisie à 23h30 reste 23h30 partout, sans décalage. Ajouter au line-up un DJ qui a un compte Yuno envoie une demande de booking (horaires du set, cachet proposé, message pour le style attendu) : il n'apparaît sur l'affiche qu'après avoir accepté depuis son app, et reste « En attente » d'ici là ; un profil sans compte est ajouté directement. Sous le sélecteur de DJ, le bloc « Artistes sans compte Yuno » met à l'affiche n'importe quel artiste : un nom, une photo, un lien Instagram — rien à valider, personne à inviter. Sur la page publique ils s'affichent à la suite des DJ Yuno, dans l'ordre que tu choisis (flèches ↑↓), et leur photo ouvre leur Instagram. Yuno compte ces clics (un par personne et par demi-heure) et affiche le total à côté du nom : c'est la mesure de ce que l'affiche rapporte aux artistes. La photo s'ajoute une seule fois : elle reste en mémoire, et « Déjà programmés chez toi » repropose ensuite l'artiste avec sa photo et son Instagram sur chaque nouvelle soirée. Rien n'est figé — toucher un artiste dans la liste (vignette, nom ou crayon) rouvre sa fiche pour changer photo, Instagram, nom ou place sur l'affiche, et comme le carnet sert la version la plus récente, une photo corrigée l'est pour toutes les soirées à venir. Un artiste invité n'est jamais un profil DJ : pas de page publique, pas de booking, pas de cachet. S'il crée un compte Yuno, retire-le de ce bloc et ajoute-le par le sélecteur de DJ. Active ensuite la billetterie, la guest list et les tables VIP selon tes besoins. Une soirée peut être publique (visible dans Explorer) ou privée avec mot de passe. Les événements sans lieu fixe peuvent utiliser une adresse secrète révélée aux acheteurs.",
  },
  "recurring-events": {
  ...
  "collaborations": {
    ...
    keywords: ["collaboration", "collab", "co-organisation", "co-org", "organisateur", "organizer", "BDE", "partenaire", "partage", "split", "contrat", "signature", "contrat-cadre", "résidence", "reprendre un contrat", "pilier", "hors du deal", "que les tables", "bloquer billets", "bloquer boissons", "périmètre", "scope", "barème", "paliers", "décompte de soirée", "fonds retenus"],
    path: "/owner/collaborations",
  ...
  "collab-night-closing": {
    title: "Collab à barème sur le CA de la soirée : décompte de fin de soirée et paiement",
    keywords: ["barème", "paliers", "tiers", "palier", "seuil", "ca total", "chiffre d'affaires de la soirée", "total de la nuit", "décompte de soirée", "décompte", "clôture de soirée", "night closing", "fonds retenus", "retenu par yuno", "held funds", "bar en caisse", "billets à la porte", "door tickets", "extras tables", "ticket z", "déclarer le chiffre", "déclaration du club", "accepter le décompte", "contester le décompte", "part organisateur sur le total", "pourcentage sur tout", "par tranche", "sur tout le total", "combien je dois à l'organisateur sur la soirée", "quand est libéré l'argent"],
    path: "/owner/collaborations",
    snippet: "Un contrat de collab peut rémunérer l'organisateur par un BARÈME sur le chiffre d'affaires total de la soirée (billets + tables + bar, bar en caisse compris) au lieu d'un % par pilier : on le choisit en proposant le contrat ou par avenant (« Barème sur le CA de la soirée »), avec les paliers (« à partir de 3 500 € → 7 % »…) et le mode : « sur tout le total » (le taux du palier atteint s'applique à tout le CA) ou « par tranche » (chaque tranche à son taux). Pendant la vente tout revient au club, mais les billets et tables vendus via Yuno sont RETENUS sur la plateforme : personne n'y touche avant le décompte. Après la soirée, dans la carte « Décompte de soirée » de la page de la collab, le club déclare ce que Yuno ne voit pas : bar en caisse (hors commandes Yuno), billets vendus à la porte (nombre + montant), consommations des tables au-delà des formules, autre poste libellé, référence du ticket Z. Yuno ajoute ses propres ventes (mêmes formules que le dashboard), applique le barème et montre la même grille à l'organisateur, qui accepte ou conteste (le club corrige et renvoie). À l'acceptation, Yuno fige les chiffres : la part de l'organisateur part d'abord des fonds retenus (virement Stripe automatique sous l'heure), le solde des fonds retenus est viré au club ; si la part dépasse les fonds retenus, le club vire le reste par SEPA avec la référence et l'IBAN affichés, et l'organisateur confirme la réception (même cycle que le complément tables : déclaré → confirmé, litige au-delà du délai). Sans compte Stripe actif chez l'organisateur, tout passe par le virement du club. Rien n'est jamais libéré sans décompte accepté ; la soirée doit être terminée pour déclarer.",
  },
  "scarcity-fomo": {
    title: "Rareté & FOMO",
    keywords: ["scarcity", "rareté", "fomo", "urgence", "urgency", "dernières places", "jauge", "compteur", "sold out", "pression"],
    path: "/owner/scarcity",
    snippet: "Les outils Rareté/FOMO affichent aux clients un signal d'urgence, réglé par soirée depuis la page Rareté : soit un badge « Dernières places » qui apparaît quand une option passe sous un seuil de remplissage, soit un compteur de places restantes, plafonnable option par option. Le signal couvre les paliers de billets, les parts de guest list (une part genrée compte ♀ et ♂ séparément) et les zones de tables. Sur la guest list, le compteur s'affiche sur les parts dont « Afficher les places restantes » est activé, ET sur toute part pour laquelle tu saisis un nombre dans « Afficher un nombre plus bas » (le nombre saisi sur la page Rareté fait foi, même si la part a coupé l'affichage) ; le badge s'affiche partout.",
  },
  "hype-score": {
    title: "Hype Score",
  ...
  "email-vip-table-block": {
    ...
    keywords: ["bloc table", "table vip", "tables vip", "bottle service", "carré", "carre", "vendre des tables", "remplir mes tables", "formule", "formules", "packs", "sur place", "sans acompte", "règlement au club", "prix qui ne s'affiche pas", "toutes les formules", "il manque des formules", "zone", "zones", "carré", "prix d'appel", "à partir de", "plan de salle", "image avant", "image après", "place de l'image", "épuré", "mesa vip", "vip table block", "alignement", "aligner", "centrer", "mise en page du bloc", "photo du carré", "arguments"],
    path: "/owner/campaigns",
    snippet: "Le bloc « Table VIP » de l'Email Studio porte l'offre ENTIÈRE, pas juste une phrase. Relié à une soirée, il affiche tes VRAIES formules avec leurs VRAIS prix, relus dans tes réglages de tables AU MOMENT DE L'ENVOI : un tarif changé la veille part corrigé, sans retoucher l'email. Chaque ligne dit le nom de la formule, ce qu'elle contient (couverts + bouteilles incluses + extras) et SON PRIX. Le prix s'affiche TOUJOURS, même quand le règlement se fait au club : une table à 300 € réglée sur place coûte 300 €, et c'est ce montant que la page de réservation affiche. Le règlement au club devient un ARGUMENT dans la ligne de bénéfices (« sans acompte »), jamais un remplacement du prix — le but est d'amener le client à réserver SUR Yuno, pas de le renvoyer au comptoir. Une formule sans prix de base affiche son minimum de consommation, et une formule sans aucun montant connu affiche « Sur demande ». TOUTES les formules de la soirée partent par défaut, des moins chères aux plus chères — on entre dans une offre par le bas. Pour n'en pousser que certaines, décroche-les une à une dans « Formules affichées » (inspecteur du bloc) : montrer 3 formules sur 8 sans le vouloir fait croire au client que le club n'a que ça. Réglages disponibles : MISE EN PAGE (Vitrine = l'offre entière avec arguments et formules ; Bandeau = relance courte en trois lignes ; Épuré = sans cadre), DÉTAIL DES TARIFS — « Formules » liste chaque formule, « Zones » ne montre que les carrés avec leur prix d'appel (« DANCEFLOOR VIP · 6 à 8 pers. · dès 300 € ») : c'est la vue épurée quand le club vend beaucoup de formules, le détail complet attendant sur la page de réservation ; une zone dont aucune formule n'est ouverte n'apparaît pas —, ALIGNEMENT gauche / centre / droite (les prix restent toujours à droite de leur ligne, pour rester comparables), ARGUMENTS DE VENTE ligne par ligne avec une coche (coupe-file, carré privatisé, hôte dédié…), VISUEL du carré ou plan de salle — disponible sur LES TROIS mises en page, à placer AVANT les tarifs (il pose l'ambiance) ou APRÈS (il sert de plan de salle, on sait alors quoi y chercher) —, NOTE DE RÉASSURANCE sous le bouton, et COULEUR d'accent — l'or VIP par défaut, qui distingue le bouton table du rouge de la billetterie. Deux automatismes : le nombre de tables encore libres s'affiche en pastille et change de ton quand ça devient urgent (« Dernière table », « Plus que 2 tables » pressent ; « 9 tables disponibles » informe) ; et quand tout est réservé la carte affiche « Complet » et RETIRE son bouton, pour ne jamais envoyer un client sur une page pleine. ⚠️ RÈGLE DE VISIBILITÉ À VÉRIFIER : par défaut ce bloc porte la règle « VIP · Table », donc SEULS les clients ayant DÉJÀ réservé une table le voient. Parfait pour relancer des habitués, mais si le but est de RECRUTER de nouveaux clients tables, il faut effacer cette règle dans l'onglet Dynamique du bloc — sinon la majorité de la liste ne verra jamais l'offre. Le départ rapide « Tables VIP » (écran + Nouvelle campagne) est déjà réglé sans cette restriction.",
  },
  "email-templates": {
  ...
  "email-automations": {
    title: "Automatisations email (recettes) et renvoi aux non-ouvreurs",
    keywords: ["automatisation", "automatisations", "automation", "automations", "recette", "recettes", "email automatique", "emails automatiques", "panier abandonné", "panier abandonne", "abandoned checkout", "checkout abandonné", "dernier appel", "last call", "merci d'être venu", "merci d'etre venu", "on t'a manqué", "on t'a manque", "pas venu", "no-show", "bienvenue", "welcome", "reconquête", "reconquete", "win-back", "winback", "client dormant", "inactifs", "passe en table", "upsell table", "table vip email", "le tarif monte", "tarif monte", "palier", "paliers", "nouvelle soirée", "nouvelle soiree", "annonce", "annoncer une soirée", "qui reçoit", "qui recoit", "audience automatique", "éligibles", "eligibles", "yuno cible", "suggestions", "yuno te propose", "allumer", "non-ouvreurs", "non ouvreurs", "renvoyer", "renvoi", "resend", "pas ouvert", "n'ont pas ouvert", "meilleure heure", "heure d'envoi", "quelle heure envoyer", "best hour", "envoi automatique", "relance automatique", "partent seuls", "flow", "flows", "parcours", "règles yuno", "regles yuno", "pression", "trop d'emails", "fatigue", "protégés", "proteges", "anti-spam", "désabonnements", "spam"],
    path: "/owner/campaigns/automations",
    snippet: "AUTOMATISATIONS EMAIL (Campagnes email → Automatisations, ou l'entrée « Automatisations email » du menu) : neuf recettes qui partent SEULES, dans le design du club, par le même moteur que les campagnes (quota, rodage, liste de suppression, pas d'envoi la nuit, liens suivis, revenu attribué par pilier). Chaque recette = un interrupteur + un délai (ou un seuil) + un modèle Email Studio + un objet, une ligne « Yuno cible : … » avec le nombre d'éligibles maintenant et le prochain départ, et un bilan (en file, en attente d'envoi, envoyés, ouvertures, clics, revenu attribué, désabonnés, exclus avec leur raison, cette semaine). AVANT LA SOIRÉE : (1) NOUVELLE SOIRÉE — 2/6/24 h après la publication d'une soirée publique à plus de 48 h qui vend quelque chose, à toute la base opt-in qui n'a pas encore sa place, FICHIERS IMPORTÉS COMPRIS (c'est la recette qui met une liste importée au travail) ; plusieurs dates publiées d'un coup = une seule annonce, la plus proche ; une re-génération de soirée récurrente n'est pas une nouveauté. (2) PANIER ABANDONNÉ — billet ou table lancés au paiement et jamais payés, 1/2/4/12 h après, si la personne a coché l'accord marketing ; l'email au meilleur revenu du marché. (3) LE TARIF MONTE — quand le palier de billetterie ouvert dépasse un seuil (75/85/95 %, pas de délai), qu'il reste au moins un billet et qu'un palier plus cher suit, à ceux qui ont cliqué la soirée dans un email ou rejoint sa liste d'attente sans acheter ; recette urgente (2 emails/24 h, 5/semaine, sans le délai de 48 h). (4) DERNIER APPEL — 12/24/48/72 h avant chaque soirée qui vend encore, à toute la base opt-in sans billet, table ni place en liste invités. (5) PASSE EN TABLE — 48/72/120/168 h avant le début, aux détenteurs d'un billet payé SANS table, tant qu'il reste une table libre (même calcul que le bloc Table VIP) ; jamais à qui a déjà une table. APRÈS : (6) MERCI D'ÊTRE VENU — 6 à 48 h après la fin, à ceux dont le QR a été scanné, avec la prochaine soirée en carte. (7) ON T'A MANQUÉ — 12 à 72 h après la fin, à ceux qui avaient une place et n'ont pas été scannés. Ces deux recettes EXIGENT le scan : sans aucun scan sur la soirée, rien ne part. RELATION : (8) BIENVENUE — 1 à 48 h après une nouvelle inscription (liste invités, formulaire, suivi), jamais pour un fichier importé ni un acheteur, et seulement après l'activation. (9) RECONQUÊTE — dernière venue il y a 45/60/90/120 jours, une fois par semestre, 300 personnes max par passage. YUNO CHOISIT QUI REÇOIT QUOI : le club ne choisit jamais l'audience d'une recette. Source = la base opt-in du club (achats, liste invités, formulaire, suivi, fichiers importés) ; exclusions AU MOMENT de l'envoi (déjà une place, acheté depuis, désabonné, injoignable, déjà écrit sous 48 h, déjà écrit pour cette soirée par un autre expéditeur, règles Yuno) ; quand la base dépasse le quota du jour, les plus engagés partent d'abord (a ouvert ou cliqué sous 90 j, puis venu sous 180 j, puis inscrit sous 30 j), les autres le lendemain — ce n'est pas un échec. Un contact reçoit au plus UNE automatisation par passage et par 48 h (panier abandonné et tarif qui monte exceptés), la plus urgente d'abord. SUGGESTIONS : « Yuno te propose d'allumer… » (bandeau de la page Automatisations, carte de la page Campagnes, notification in-app une fois par recette et par mois) liste les recettes ÉTEINTES que les 30 derniers jours justifient — ≥ 3 paniers abandonnés, soirée sous 10 j avec ≥ 50 contacts, tables libres et ≥ 20 billets vendus, soirée publiée sans email, soirées scannées, ≥ 30 clients silencieux, ≥ 10 inscriptions, palier > 70 % — avec un bouton « Allumer » qui crée le modèle Yuno et active la recette. Allumer une recette sans modèle crée automatiquement le modèle Yuno (retouchable dans le studio) ; « Aperçu et test » envoie l'email tel qu'il partira avec la prochaine soirée. La fiche client (CRM) montre les emails automatiques reçus, ouverts, cliqués ou écartés ; le récap hebdo du lundi ajoute « automatisations : X emails, Y ventes attribuées ». RÈGLES YUNO (non modifiables, tous expéditeurs confondus — la réputation d'envoi est partagée) : une personne ne reçoit pas plus d'une automatisation par 24 h ni trois par semaine (urgentes : 2/24 h, 5/semaine) ; une campagne manuelle 3/jour et 8/semaine ; 8 emails marketing en 90 jours sans une ouverture = la personne « dort » ; deux désabonnements récents = plus d'automatisation 30 jours ; une soirée ne déclenche qu'UN message par recette et par personne quel que soit l'expéditeur, les recettes du club avant celles de Yuno. GARANTIES : personne ne reçoit une automatisation sans être dans la base opt-in ; jamais entre 23 h et 9 h ; un email sans soirée à relier perd ses blocs Yuno (jamais de tarifs inventés). Le moteur passe toutes les 5 minutes ; chaque envoi automatique a son rapport complet comme une campagne. L'assistant peut lister les recettes, qui Yuno cible et les suggestions (list_email_automations), et en allumer/éteindre une, changer son délai ou son seuil (set_email_automation, avec confirmation) — mais il ne crée pas le modèle : sans modèle, le pro clique « Créer le modèle Yuno » ou « Allumer » sur la page. RENVOYER AUX NON-OUVREURS (écran Planification ou rapport d'une campagne partie) : le même email sous un autre objet, 24/48/72 h après la fin de l'envoi, à ceux qui ne l'ont pas ouvert ; jamais aux acheteurs, désabonnés, injoignables, ni après le début, ni la nuit ; un seul renvoi par campagne. MEILLEURE HEURE DE LA BASE (écran Planification) : ouvertures des 120 derniers jours par heure et par jour (Paris) ; sous 30 ouvertures rien n'est conclu.",
  },
  ...
  "import-email-list": {
    title: "Importer une base clients existante (email + SMS en un seul fichier)",
    keywords: ["importer", "import", "importer ma liste", "liste email", "base email", "base clients", "csv", "fichier", "mailchimp", "brevo", "shotgun", "dice", "weezevent", "contacts", "ajouter des contacts", "j'ai déjà une liste", "j'ai 0 client", "aucun client", "consentement", "attestation", "rgpd import", "liste importée", "segment importé", "deux listes", "plusieurs fichiers", "importer des numéros", "liste sms", "téléphones", "doublon", "doublons", "réimporter", "reimporter", "importer deux fois", "même fichier", "meme fichier", "fusionner mes listes", "fusion", "liste en double"],
    path: "/owner/campaigns",
    snippet: "Bouton « Importer ma liste » en haut de la page Campagnes (le même bouton existe sur la page SMS). UN SEUL fichier alimente les deux canaux : les emails partent vers les campagnes email, les numéros vers les campagnes SMS — deux interrupteurs, une seule attestation, plus besoin d'importer deux fois. Accepte un CSV, un export d'une autre billetterie ou d'un outil d'emailing, ou un simple copier-coller. Les colonnes sont reconnues automatiquement quel que soit leur nom ou leur ordre : email, téléphone, prénom, nom, mais aussi ville, pays, zone, âge, genre, total dépensé, nombre d'évènements, dernier achat, opt-in newsletter — elles s'affichent en vert dès le dépôt du fichier. Le numéro national (06…) est complété avec le pays choisi. Avant de valider : nom de la liste (prérempli avec le nom du fichier), origine du consentement, date de collecte, attestation obligatoire (la pièce à produire si un destinataire conteste). Les doublons, lignes illisibles, adresses mortes et numéros ayant dit STOP sont écartés et comptés ; un désabonné n'est JAMAIS réactivé par un import. Chaque fichier reste un segment à part (« Listes importées » à l'écran Audience, renommable). Une fois l'import terminé, Yuno propose une segmentation intelligente de la base (voir l'article dédié). RÉIMPORT ET DOUBLONS : avant d'écrire quoi que ce soit, Yuno compare le fichier à ce que le pro a déjà. Un fichier déjà importé à l'identique met à jour la liste existante au lieu d'en créer une jumelle — il n'y a jamais deux listes pour un même fichier. Un fichier qui reprend une liste existante (toute la base réexportée alors qu'un morceau était déjà là) affiche les listes concernées avec le nombre de contacts partagés et laisse choisir : « N'en faire qu'une seule liste » (la nouvelle prend tout, les listes qu'elle vide sont retirées des audiences) ou « Garder mes listes séparées » (chacun reste rattaché à la liste par laquelle il est arrivé). Une liste retirée garde son attestation de consentement, et les désabonnés restent désabonnés dans tous les cas. C'est ce qui empêche une liste d'annoncer plus de monde qu'elle n'en contient au moment d'envoyer.",
  },
  "smart-segments": {
    title: "Segmentation intelligente de la base (fichier importé + clients Yuno + engagement)",
    keywords: ["segmentation", "segments intelligents", "segment", "segmenter", "proposer des segments", "analyser ma base", "analyse", "clients de paris", "localisation", "ville", "étranger", "gros dépensiers", "guest list", "entrées gratuites", "acheteurs de billets", "meilleurs clients", "fidèles", "habitués", "venus une fois", "endormis", "à réactiver", "reconquérir", "nouveaux", "âge", "genre", "joignables", "cibler", "ciblage", "fidélisation", "fidéliser mes clients"],
    path: "/owner/campaigns",
    snippet: "Après un import (ou via le bouton « Segments intelligents » en haut des pages Campagnes et SMS), Yuno analyse TOUTE la base (fichier importé + clients venus par Yuno, plus ce que les campagnes ont appris) et PROPOSE des segments : chacun affiche son nombre de contacts, combien sont joignables par email et par SMS, sa part de la base et la RAISON de la proposition. Familles : localisation (clients par pays, par zone/ville, à l'étranger), dépenses (entrées gratuites / guest list = dépense 0, acheteurs de billets = moins de 60 € par soirée, gros paniers tables & bouteilles = 60 € et plus par soirée, meilleurs clients = 10 % les plus dépensiers), fréquence (venus une fois, habitués 2-3 soirées, fidèles 4 et plus), récence (actifs < 90 jours, à réactiver 3-12 mois, endormis > 1 an, anciens habitués à reconquérir, nouveaux à fidéliser), profil (18-21, 22-25, 26-30, 31+, femmes, hommes), consentement (abonnés newsletter déclarés dans l'ancien outil) et canaux (email + SMS, SMS uniquement). Un segment n'est proposé qu'à partir de 10 personnes, et seulement si le fichier portait la donnée (sans ville ni dépenses, pas de proposition géographique ou financière : réimporter un export plus complet). QUATRE SEGMENTS YUNO sont proposés en plus, sans seuil, calculés sur les ventes réelles chez ce pro (billets, tables, guest list) et les fichiers importés : « Prend des tables » (a déjà réservé au moins une table VIP), « Panier moyen élevé » (dépense par soirée au-dessus d'un seuil : Yuno propose SA valeur pour ce compte — le quart des clients qui dépensent le plus d'après l'historique de commandes, ou à défaut le prix par convive de la formule de table la moins chère, ou 1,5 × le billet le plus cher — et le pro peut taper son propre montant dans le champ « Seuil de dépense par soirée », l'effectif se recalcule aussitôt), « Vus il y a moins de 60 jours » (achat, venue ou clic récent) et « Habitués qui décrochent » (3 soirées et plus, plus rien depuis 90 jours). Ils apparaissent dans ce dialogue ET directement à l'écran Audience du studio email (section « Segments Yuno, en un clic ») : un clic crée le segment et l'ajoute à la campagne en cours, avec son effectif joignable ; une fois créé il rejoint les segments intelligents. Valable pour un club comme pour un organisateur. Le pro coche ce qu'il garde et clique « Créer » : les segments apparaissent sous « Segments intelligents » à l'écran Audience du studio email et dans le menu Audience de l'éditeur SMS. Ils sont dynamiques : recalculés à chaque envoi, mis à jour par un nouvel import, un désabonné en sort seul. Une même personne présente dans plusieurs fichiers est consolidée sur sa ligne la plus récente. Corbeille dans la liste des segments pour en retirer un ; « Relancer l'analyse » pour de nouvelles propositions. Dès que deux audiences sont cochées, un réglage « Réunir / Croiser » apparaît : Réunir envoie à ceux qui sont dans l'une OU l'autre (chaque personne reçoit un seul email), Croiser envoie seulement à ceux qui sont dans TOUTES à la fois — par exemple « Clients · Paris » croisé avec « Actifs (90 derniers jours) » = les Parisiens actifs. Le compteur de droite affiche le nombre réel après le choix. Même réglage dans l'éditeur SMS quand plusieurs segments intelligents sont cochés. Conseil : envoyer d'abord aux « abonnés newsletter déclarés » et aux « actifs » pour chauffer la réputation d'envoi, réserver les « endormis » à une offre forte et rare.",
  },
  "contact-base": {
    title: "Ma base de contacts : import ∪ clients Yuno, engagement et effet de chaque campagne",
    keywords: ["ma base", "base de contacts", "base clients", "contact base", "mes contacts", "engagement", "engagés", "silencieux", "lecteurs", "cliqueurs", "jamais sollicités", "injoignables", "désabonnés", "qui a ouvert", "qui a cliqué", "effet sur ma base", "effet de la campagne", "bilan campagne", "segments qui ont bougé", "exporter ma base", "exporter mes clients", "export", "excel", "tableur", "clients yuno", "venus par yuno", "doublon", "doublons", "même personne", "fichier et yuno", "mise à jour de la liste", "liste mise à jour", "actualiser"],
    path: "/owner/campaigns/contacts",
    snippet: "Page « Ma base de contacts » (Marketing & CRM → Campagnes email → Ma base, ou bouton « Ma base » en haut de la page Campagnes) : TOUTE la base en une liste — le fichier importé ET les personnes venues par Yuno (guest list, billets, tables), une ligne par personne. Une personne présente des deux côtés est reconnue une seule fois : l'identité Yuno (prénom, téléphone, compte) gagne, les dépenses et soirées s'additionnent (ancien outil + Yuno). Chaque campagne envoyée met la base à jour toute seule (à la fin de l'envoi, puis toutes les 10 minutes) : ouvertures, clics, désabonnements, adresses mortes. Six statuts par contact : Engagé (a cliqué depuis 90 jours ou ouvert ≥ 2 campagnes), Lecteur (ouvre sans cliquer), Silencieux (≥ 2 emails reçus, aucune ouverture en 6 mois), Jamais sollicité, Injoignable (adresse morte, plainte), Désabonné. La carte « Effet sur votre base » (rapport de campagne + page) dit ce que l'envoi a changé : ouvertures, clics, nouveaux engagés, réactivés, où en sont les destinataires, et ce qui a bougé dans les segments (« +3 dans Meilleurs clients », photo « avant » prise à la fin de chaque envoi). La page filtre par statut, origine (fichier / venus par Yuno / les deux), segment et liste, cherche par nom, email ou ville, trie par récence, engagement, dépenses ou soirées. « Exporter la base » (aussi sur la page Clients) sort un Excel complet : coordonnées, origine, compte Yuno, statut, emails reçus, ouvertures, clics, dernier signe, dépenses et soirées (fichier + Yuno), guest lists, ville, âge, liste d'origine, segments. La segmentation intelligente propose en plus les familles engagement (engagés, cliqueurs, lecteurs, silencieux, jamais sollicités) et origine (clients Yuno, venus par Yuno seulement, des deux côtés, inscrits en guest list). Un statut décrit, il n'autorise jamais : un segment ne joint que les contacts consentants.",
  },
  "email-bounces": {
  ...
  "marketing-consent": {
    ...
    path: "/owner/help",
    snippet: "L'accord d'un client vaut pour TON club entier, pas pour une soirée : il coche la case une seule fois, puis les réservations suivantes affichent juste « inscrit » avec un lien de désinscription. L'accord donné à un autre club ne te profite jamais, et le tien ne profite à personne d'autre — un nouveau client voit toujours une case décochée portant TON nom. Sous tes deux cases (email et SMS, toujours séparées), une troisième case à part propose les soirées de Yuno lui-même : elle ne remplace pas la tienne, ne la coche pas et ne te prend rien — un client peut accepter tes actus et refuser celles de Yuno, ou l'inverse. Yuno ne puise JAMAIS dans ta liste pour ses propres envois. Ces trois cases sont les mêmes au paiement d'un billet, d'une table, et à l'inscription sur une guest list. Tu ne peux pas ajouter à la main ni importer une liste : les campagnes email et SMS ne partent qu'aux contacts au consentement actif pour ton club, vérifié au moment de l'envoi. Chaque accord est archivé avec sa date, son canal, sa langue et la phrase exacte affichée, donc la preuve existe en cas de contrôle CNIL. Côté SMS, la mention « STOP pour ne plus recevoir » est ajoutée automatiquement à la fin de CHAQUE campagne (obligation légale distincte du consentement) et tu ne peux pas la retirer ; quand quelqu'un répond STOP, il est retiré immédiatement de toutes les listes SMS.",
  },
  "sms": {
    title: "SMS & crédits SMS",
    keywords: ["sms", "texto", "crédit", "credits", "campagne sms", "message"],
    path: "/owner/sms",
    snippet: "Les campagnes SMS (Marketing & CRM → SMS, puis Campagnes SMS) marchent avec des crédits prépayés : 1 crédit = 1 SMS de 160 caractères en texte standard (un emoji ou un texte long en compte 2 ou 3, l'éditeur te le montre avant d'envoyer), les échecs sont remboursés et les crédits n'expirent jamais. Tes contacts SMS se constituent tout seuls : chaque acheteur de billet ou de table qui coche « Offres par SMS » entre dans ta liste, et tu peux importer une liste existante (Importer ma liste) en attestant l'origine du consentement, comme pour l'email — les numéros ayant dit STOP ne sont jamais réabonnés. Cinq audiences : tous les contacts, « sans billet pour la soirée » (la relance qui remplit une soirée, elle n'écrit jamais à ceux qui ont déjà payé), « acheteurs de la soirée » (rappel J-1), VIP, et chaque liste importée. Lie une soirée pour insérer son lien court suivi : le rapport montre alors les clics, les billets et tables vendus grâce au SMS et les crédits dépensés, en plus de la livraison en direct. Envoie-toi un test, puis envoie maintenant ou programme. Ton nom d'expéditeur et la mention STOP sont ajoutés automatiquement ; par défaut rien ne part entre 20 h et 8 h ni le dimanche.",
  },
  "push-notifications": {
  ...
  "customers-crm": {
    ...
    snippet: "La page Clients regroupe tous tes clients avec leur historique (visites, dépenses, panier moyen) et une segmentation automatique RFM (champions, à risque, fidèles, prometteurs, nouveaux, dormants, perdus — calculée côté serveur, la même que le ciblage push). La récence est un fait de calendrier, jamais une comparaison : moins de 15 jours, puis 30, 60, 90 — un client venu cette semaine ne peut PAS être classé dormant ou perdu, même s'il est le moins récent de ta liste ; « perdu » veut dire plus de 90 jours sans activité. Un habitué silencieux depuis plus de 60 jours ressort en « à risque » avant d'être compté comme fidèle : c'est lui qu'il faut rappeler. La fréquence et le montant, eux, se comparent bien à tes autres clients. Tu peux bannir un client par email — le videur est alerté si son billet est scanné. SEGMENTS SAUVEGARDÉS : compose des filtres (segment RFM, palier, récence, pilier, churn), puis « Enregistrer comme segment » — le segment devient réutilisable comme audience dans les push ET les campagnes email (toujours croisé avec l'opt-in newsletter pour l'email). Le contenu est dynamique : recalculé à chaque envoi, un client qui ne matche plus en sort tout seul. L'outil list_saved_segments te donne la liste et la taille live de chaque segment.",
  },
  "analytics": {
    title: "Analytics",
  ...
  "support-access": {
    ...
    snippet: "Quand tu demandes un coup de main pour configurer ton compte, l'équipe Yuno t'envoie une DEMANDE d'accès assisté : elle arrive en notification et s'affiche dans Paramètres → Assistance Yuno, et il ne se passe strictement rien tant que tu n'as pas cliqué « Accorder l'accès ». Une fois accordé, un membre de l'équipe Yuno peut ouvrir une session dans ton compte pour créer et modifier tes soirées, tes tarifs et tes créneaux, configurer guest lists, liens d'invitation, tables VIP et plan de salle, et compléter ton profil public (nom, logo, bio, liens). Ce qu'il ne peut PAS faire n'est pas une promesse mais un refus de la base de données : compte Stripe et coordonnées bancaires, virements et remboursements, cycle de règlement des promoteurs, email de connexion, code PIN, double authentification, suppression ou suspension du compte — chaque tentative est rejetée, y compris s'accorder plus d'accès. Chaque écriture faite pendant une session est journalisée et tu lis le journal sur cette même page (« Modifié · Guest list », horodaté), avec l'historique de tes autorisations passées. L'autorisation vaut jusqu'à ce que tu la coupes (elle n'expire jamais d'elle-même), une session ouverte se termine toujours au bout de 12 heures, et le bouton « Couper l'accès » révoque l'autorisation et arrête immédiatement toute session en cours — tu peux couper à tout moment, sans justification. Tant qu'une session est ouverte, une bannière « Assistance Yuno » reste affichée en permanence à l'écran : personne ne travaille dans ton compte en silence. La même page existe pour les managers (/manager/support-access) et pour les organisateurs (/organizer-app/support-access). Tu n'as pas besoin d'attendre qu'on te sollicite : le bouton « Demander à Yuno de tout configurer », sur cette page, ouvre l'accès immédiatement — ton clic vaut accord, il n'y a pas de second écran de confirmation. La proposition apparaît aussi à deux autres moments : en haut du guide de configuration pour un club, sur la dernière étape de l'onboarding pour un organisateur, et — si Yuno t'a invité — juste après l'activation de ton compte, avec le détail des garanties. Répondre « non merci » ne bloque rien : tu peux changer d'avis quand tu veux depuis Paramètres → Assistance Yuno. À noter enfin : ton numéro SIRET, ta raison sociale et ton compte Stripe restent à remplir par toi — ce sont des actes qui engagent ton entreprise, la base les refuse à quiconque d'autre.",
  },
  "orders-page": {
    title: "Page Commandes — les quatre piliers de la soirée",
    keywords: ["commandes", "orders", "gestion des commandes", "journal", "historique", "qui a acheté", "qui est inscrit", "voir les inscrits", "liste des inscrits", "inscriptions guest list", "guest list commandes", "onglet guest list", "suivre les inscriptions", "qui est entré", "taux d'entrée", "show-up", "no-show", "présences", "onglets"],
    path: "/owner/orders",
    snippet: "Commandes (Ventes & finances → Commandes) est le journal de tout ce qui remplit ta soirée, en QUATRE onglets, un par pilier : Boissons, Billets, Guest list et Tables VIP. Les trois piliers payants affichent Commandes, Revenu total et Panier moyen. L'onglet GUEST LIST, lui, ne parle pas d'argent — une inscription vaut une place à la porte, pas un paiement : il affiche Inscriptions, Entrés et Taux d'entrée (le pourcentage de gens inscrits qui se sont réellement présentés ; les annulations ne comptent ni au numérateur ni au dénominateur). Il liste toutes les inscriptions de TOUTES les parts de la soirée d'un seul coup — club, DJ, promoteur, agence, part personnalisée — avec pour chaque personne son nom, son email, son téléphone, le type d'entrée (Entrée, Entrée + conso, Table), la liste dont elle vient, et son état : Inscrit, Entré (avec l'heure de scan) ou Annulé. Tu filtres par état, par type d'entrée, tu cherches par nom, email, soirée ou liste, et tu tries par date d'inscription ou par nom. Le bouton « Imprimer / Exporter » y sort la même liste de porte, liste complète ou tableur que sur la page Guest list. La différence avec la page Guest list : celle-ci sert à CONFIGURER (quotas, parts, liens de distribution) soirée par soirée, l'onglet Commandes sert à SUIVRE les personnes, toutes soirées confondues. Le taux d'entrée est le chiffre qui compte le lendemain : une liste pleine dont la moitié n'est pas venue ne remplit pas un club.",
  },
  "print-export-lists": {
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          kind: { type: "string", enum: ["new_event", "abandoned_checkout", "tier_closing", "last_call", "table_upsell", "post_event_thanks", "post_event_missed", "welcome", "win_back"], description: "The recipe" },
          enabled: { type: "boolean", description: "true to enable, false to disable" },
          delay_hours: { type: "integer", description: "Optional delay in hours (win_back in hours too: 90 days = 2160). abandoned_checkout 1-12, last_call 12-72 before start, table_upsell 48-168 before start, new_event 2-24 after publication, post_event 6-72 after end, welcome 1-48, win_back 1080-2880. Ignored for tier_closing." },
