...
// Description longue : le tiroir grandit vers le haut, le pied reste collé en bas.
  ...
  <Drawer defaultOpen>
    <DrawerContent style={{ background: '#0E0E10', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
      <DrawerHeader>
        ...
        <DrawerDescription className="font-sans" style={bodyText}>
          Ta bouteille est préparée dès validation du paiement et apportée à ta table par
          l'hôte VIP du club. Les softs inclus sont servis en même temps. Une bouteille
          entamée ne peut être ni remboursée ni emportée, et le service ferme trente
          minutes avant la fin de la soirée.
        </DrawerDescription>
      </DrawerHeader>
      <DrawerFooter>
        <Button>Choisir une bouteille</Button>
        <DrawerClose asChild>
