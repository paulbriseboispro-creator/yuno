...
// En-tête complet du système public : kicker mono rouge, titre display
// uppercase, description Inter grise.
export const AvecKicker = () => (
  <Dialog defaultOpen>
...
// En-tête réduit au titre : la description part en sr-only pour rester
// accessible sans peser dans la composition.
    ...
    <DialogContent style={{ ...panel, borderRadius: 8 }}>
      <DialogHeader>
        ...
        <DialogDescription className="sr-only">
          Confirmation d'annulation de la commande au bar.
        </DialogDescription>
      </DialogHeader>
      <p className="font-sans" style={{ ...bodyText, margin: 0 }}>
        Les 24,90 € sont remboursés sur ta carte sous 5 jours ouvrés.
      </p>
      <DialogFooter>
        <DialogClose asChild>
          <Button variant="outline">Garder ma commande</Button>
        </DialogClose>
