...
export const TitreCourt = () => (
  <Dialog defaultOpen>
    <DialogContent className="sm:max-w-sm" style={{ ...panel, borderRadius: 8 }}>
      <DialogHeader>
...
// Titre long : Space Grotesk 700 uppercase, tracking -0.025em — il passe sur deux
// lignes sans casser la grille de DialogContent ni pousser le pied hors cadre.
    ...
    <DialogContent style={{ ...panel, borderRadius: 8 }}>
      <DialogHeader>
        ...
        <DialogTitle className="font-display font-bold uppercase" style={bigTitle}>
          Confirmer ta table pour 6 au Sala Mirador — 450 €
        </DialogTitle>
        <DialogDescription className="font-sans" style={bodyText}>
          Madrid · samedi 14 août, 23:00
        </DialogDescription>
      </DialogHeader>
      <div style={block}>
